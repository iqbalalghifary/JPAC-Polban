    ...
    <div className="container pt-2 pb-5">
      <div className="section-header pt-5 pb-5 text-center">
        ...
        <h6 className="section-subtitle mr-auto ml-auto">
          ...
          Lulus/Ijazah saat mengisi formulir registrasi di situs website Pusat Karir Polban. <br />{" "}
          <br />
          4) Bagi mahasiswa atau alumni non-Polban, kirimkan biaya keanggotaan baru ke rekening BRI
          cabang Kampus Polban: <br />- Nomor rekening: 09-00-00-1091 <br />- Atas nama :
          ...
          Anda kami terima. Hal ini ditujukan untuk menghindari kesalahan pemrosesan User Name anda
          di website Pusat Karir Polban. <br /> <br />
        </h6>
        <h3 className="section-title text-left">
        ...
        <h6 className="section-subtitle mr-auto ml-auto">
          ...
          <br />
          4) Bagi mahasiswa atau alumni non-Polban, kirimkan biaya keanggotaan baru ke rekening BRI
          cabang Kampus Polban: <br />- Nomor rekening: <b>09-00-00-1091</b> <br />- Atas nama :{" "}
