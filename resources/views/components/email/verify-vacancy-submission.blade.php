                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td>
                        <p>Hi there,</p>
                        <p>Based on the validation results conducted by our team, The vacancy submission has been activated. Here are the detailed information regarding your vacancy post: </p>
                              ...
                              <td align="left">
                                <table class="main-table" role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    ...
                                    <tr>
                                      <td style="padding: 8px 15px;">Vacancy Title</td>
                                      <td style="padding: 8px 15px;">{{ $details['title'] }}</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
